...
def get_photo_folder(type_photo):
    ...
    if type_photo == "Original Photos":
        dir_path = get_dir('data/original_images')
    if type_photo == "Processed Photos":
        dir_path = get_dir('data/processed_images')
    if type_photo == "Augmented Photos":
        dir_path = get_dir('data/augmented_images')
        # os.path.join(get_dir('StyleCariGAN/checkpoint/StyleCariGAN'), 'cari_resnet.pth')
