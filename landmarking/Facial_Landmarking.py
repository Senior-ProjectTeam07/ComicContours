...
def main():
    if not os.path.exists(get_dir('data/processed_images')):
        os.makedirs(get_dir('data/processed_images'))
    ...
    output_directory = os.path.abspath(get_dir('data/processed_images'))
    for path in image_paths:
